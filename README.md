...
| `Results_plots.ipynb` | Jupyter Notebook used to plot Colorado true and TL3 predicted SWE maps (scatter plots), calculates $R^2$ results, calculates bias results, and plots feature importance box plots. |
